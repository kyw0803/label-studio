...
![Screenshot of support reports page](/images/admin/support-reports.png)
...
* **Send reports via email**--Enter the email address that should receive the reports. Separate multiple email addresses with a comma. 
* **Send reports to the support delivery endpoint**--Configure the endpoint using the `SUPPORT_REPORT_DELIVERY_URL` environment variable. 
